    ...
    return (
        <div className="relative h-full w-full bg-[url('/images/1.png')] bg-no-repeat bg-center bg-fixed bg-cover">
            <div className="bg-black w-full h-full lg:bg-opacity-50">
                ...
                <div style={{ backgroundColor: 'rgba(34, 34, 34, 1)' }} className="px-16 py-16 self-center mt-1 lg:w-2/5 lg:max-w-md rounded-md w-full ml-80">
                <h2 className="text-white text-4xl mb-9 font-semibold">
                        ...
                        <button className="bg-green-600 py-3 text-white rounded-md w-full mt-10 hover:bg-red-700 transition
                        ">
